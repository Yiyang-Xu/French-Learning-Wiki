...
- **Notes 注释**
  - *vous*：正式场合、初次见面或礼貌称呼；*tu*：熟人、朋友、同学之间。
  - *et elle…* 可用于引出另一个人；*française* 是形容词，*Française* 可作名词。

- **Grammaire 语法**
  1. La conjugaison des verbes — 动词变位
     - 本课重点：*être* 与 *s’appeler* 的直陈式现在时。
  2. Le genre : le masculin et le féminin — 阳性和阴性
     - 注意名词性别，以及代词、形容词等与名词保持一致。
  3. L’interrogation — 疑问句
     - 三种基本形式：语调疑问、*est-ce que*、主谓倒装。
  4. L’interrogatif *qui* — 疑问词 *qui*
     - 用于询问“谁”：*Qui est-ce ? / Qui êtes-vous ?*

- **Savoir dire 学会说**
  - Saluer — *Bonjour. / Bonjour, monsieur.*
  - Se présenter — *Je suis… / Je m’appelle…*
  - Demander et dire le prénom et le nom — *Qui est-ce ? / C’est…*

- **Prononcez 发音**
  - *C’est une question ?* — 区分陈述句与疑问句语调。
